...
frontmatter: true 				# true/false. Whether to include acknowledgements
output:
...
biblio-style: apalike				# Download your specific bibliography database file and refer to it in the line above.
csl: csl/apa.csl				# Download your specific csl file and refer to it in the line above.
lot: true 					# true/false. Whether to include a list of tables
lof: true 					# true/false. Include the list of figures
fontsize: 11pt					# Change the fontsize within the document
space_between_paragraphs: false 		# true/false. Whether to include a blank line between each paragram
#header-includes:
#- \usepackage{tikz}
---
...
```{r, fig.cap="Some Figure"}
include_graphics("figure/reed.jpg")
```
